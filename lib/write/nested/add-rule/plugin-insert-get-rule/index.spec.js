...
test('redput: insert-get-rule: transform with options', (t) => {
...
test('redput: insert-get-rule: transform with options: esm', (t) => {
...
test('redput: insert-get-rule: transform with options: off', (t) => {
